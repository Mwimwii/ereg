...
<body>
  ...
  <div class="container-fluid">
    ...
    <!-- NavBarLogo -->
    <a class="navbar-brand" href="memos_view.html"><img src="../img/ZM_Coat_of_Arms.png"  height="50"></a>
    <!--./NavBarLogo -->
                ...
                <td>
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                      <a class="dropdown-item text-success" href="#"><i class="bx bxs-check-circle mr-2"></i> Approve </a>
                      <a class="dropdown-item" href="#"><i class="bx bxs-pencil mr-2"></i> Edit</a>
                      <a class="dropdown-item text-danger" href="#"><i class="bx bxs-error-circle mr-2"></i> Reject</a>
                    </div>
                  </div>
                </td>
              </tr>
