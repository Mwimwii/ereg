      ...
      <nav class="navbar navbar-expand-lg bg-success">
        <div class="container-fluid">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item text-white">Tasks</li>
            </ol>
                ...
                <td>
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                      <a class="dropdown-item text-info" href="#"><i class="fas fa-bell mr-2"></i> Remind</a>
                      <a class="dropdown-item text-success" href="#"><i class="fas fa-check-circle mr-2"></i> Mark Completed</a>
                    </div>
                  </div>
                </td>
              </tr>
