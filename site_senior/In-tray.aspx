...
<head>
    ...
    <title>In-Tray E-Registry</title>
...
<body>
  ...
  <div class="container">
      ...
      <nav class="navbar navbar-expand-lg bg-success">
        <div class="container-fluid">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item text-white">In-Tray</li>
            </ol>
                ...
                <td>
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
                      <a class="dropdown-item text-default" href="#"><i class="fas fa-tasks mr-2"></i> Work on It</a>
                      <a class="dropdown-item text-secondary" data-toggle="modal" data-target="#assingTask"><i class="fas fa-tasks mr-2"></i> Assign</a>
    ...
    <!-- assign modal -->
    <div class="modal fade" id="assingTask" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            assign ment form to be added here from lubundas designed page
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
            <button type="button" class="btn btn-success"> <i class="fas fa-check pr-2"></i>Assign </button>
          </div>
        </div>
      </div>
    </div>
